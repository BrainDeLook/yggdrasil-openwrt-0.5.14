...
return network.registerProtocol('yggdrasil',
	{
		...
		renderFormOptions: function(s) {
			...
			o=s.taboption('general',form.Value,'group_password',_('Group password'),_('Restrict traffic to nodes configured with the same password. Peering connections and routing are unaffected; public services will be unreachable when this is set.'));
			o.password=true;
			o.optional=true;
